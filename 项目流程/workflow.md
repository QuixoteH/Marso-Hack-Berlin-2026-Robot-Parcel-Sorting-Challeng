...
This index presents the work in execution order. It distinguishes reproducible facts from historical conclusions; full primary reports remain in [实验档案](../实验档案/README.md).
...
Start with the task contract, then use the method documents for exact commands and preserved evidence.
